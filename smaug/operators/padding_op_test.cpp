...
TEST_CASE_METHOD(SmaugTest, "padding a 4D tensor", "[refop]") {
    ...
    auto paddingOp = new PaddingOp<ReferenceBackend>("padding", workspace());
    paddingOp->setInput(input, 0);
    paddingOp->setPadder(0);
