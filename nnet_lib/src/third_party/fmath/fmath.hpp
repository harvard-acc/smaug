...
const size_t EXPS_TABLE_SIZE = 10;
...
*/
template<size_t N = EXPS_TABLE_SIZE>
struct ExpVar {
	enum {
		s = N,
		n = 1 << s,
...
template<size_t EXP_N = EXPS_TABLE_SIZE, size_t LOG_N = LOG_TABLE_SIZE, size_t EXPD_N = EXPD_TABLE_SIZE>
struct C {
