...
class SMVOperatorTest(smaug_test.SmaugTest, OperatorTest):
  def __init__(self, *args, **kwargs):
    super(SMVOperatorTest, self).__init__(*args, **kwargs)
...
class RefOperatorTest(smaug_test.SmaugTest, OperatorTest):
  """RefOperatorTest should have no reorder operators because all the inputs are
  already in NCHW format.
  """

  def __init__(self, *args, **kwargs):
    super(RefOperatorTest, self).__init__(*args, **kwargs)
